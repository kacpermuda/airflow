...
def convert_asset_to_openlineage(asset: Asset, lineage_context) -> OpenLineageDataset:
    ...
    service_name, schema, table = path_parts[0], path_parts[1], path_parts[2]
    return OpenLineageDataset(namespace=f"oracle://{authority}", name=f"{service_name}.{schema}.{table}")
