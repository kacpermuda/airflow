...
def create_asset(*, host: str, port: int = 22, path: str, extra: dict | None = None) -> Asset:
...
def convert_asset_to_openlineage(asset: Asset, lineage_context) -> OpenLineageDataset:
    ...
    return OpenLineageDataset(namespace=f"sftp://{parsed.netloc}", name=parsed.path.lstrip("/") or "/")
